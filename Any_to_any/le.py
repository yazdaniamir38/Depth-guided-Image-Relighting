...
light_estimation.load_state_dict(torch.load('./checkpoint_epochcorrected_100.pth',map_location='cpu'))
...
class le(torch.nn.Module):
    def __init__(self, requires_grad=False):
        ...
        color = [light_estimation.module.pool, light_estimation.module.color1, light_estimation.module.relu1,
             light_estimation.module.color2, light_estimation.module.relu2, light_estimation.module.color3]
        dir = [light_estimation.module.pool, light_estimation.module.dir1, light_estimation.module.relu3,
