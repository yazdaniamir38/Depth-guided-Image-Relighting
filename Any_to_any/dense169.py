...
class Model(nn.Module):
    def __init__(self):
        ...
        ############# Block4-up  8-8  ##############
        self.Jdense_block4 = BottleneckDecoderBlock(640, 256)#512
        self.Jtrans_block4 = TransitionBlock(640+256, 128)#768
        self.Jresidual_block41 = ResidualBlock(128)
        self.Jresidual_block42 = ResidualBlock(128)
        self.ATdense_block4 = BottleneckDecoderBlock(640, 256)#512
        self.ATtrans_block4 = TransitionBlock(640+256, 128)#768
        self.ATresidual_block41 = ResidualBlock(128)
        self.ATresidual_block42 = ResidualBlock(128)
        self.Wdense_block4 = BottleneckDecoderBlock(640, 256)#512
        self.Wtrans_block4 = TransitionBlock(640+256, 128)#768
